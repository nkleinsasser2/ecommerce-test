...
/// </summary>
public class TestBaseClass<TEntryPoint> where TEntryPoint : class
{
...
public class TestWriteFixture<TEntryPoint, TWContext> : TestBaseClass<TEntryPoint>
    ...
    where TEntryPoint : class
{
    ...
    public TestFixtureCore(TestFixture<TEntryPoint, DbContext> integrationTestFixture, ITestOutputHelper outputHelper)
    {
    ...
    public TestFixture<TEntryPoint, DbContext> Fixture { get; }
    ...
    where TWContext : DbContext
{
    protected TestWriteBase(
        ...
        new TestFixture<TEntryPoint, DbContext>(), outputHelper)
    {
        Fixture = integrationTestFixture;
    }
    ...
    where TWContext : DbContext
{
    ...
    public new TestFixture<TEntryPoint, TWContext> Fixture { get; }
}
